              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div className="bg-orange-50 dark:bg-orange-900/20 p-2 rounded border border-orange-200 dark:border-orange-900/50">
                    <span className="font-medium text-orange-600 dark:text-orange-400">Commits:</span> {project.commits?.length || 0}
                  </div>
                  <div className="bg-orange-50 dark:bg-orange-900/20 p-2 rounded border border-orange-200 dark:border-orange-900/50">
                    <span className="font-medium text-orange-600 dark:text-orange-400">Meetings:</span> {project.meetings?.length || 0}
                  </div>
                  <div className="bg-orange-50 dark:bg-orange-900/20 p-2 rounded border border-orange-200 dark:border-orange-900/50">
                    <span className="font-medium text-orange-600 dark:text-orange-400">Contributors:</span> {project.users?.length || 0}
                  </div>
                </div>
